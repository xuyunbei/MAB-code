function plottingStochasticRegret_Fill(environment,MatrixArmsPlayed,MatrixArmsPlayed_2, col, holding)

[NbrRuns, Horizon] = size(MatrixArmsPlayed);
...
for run = 1:NbrRuns;
    ...
    regret_2 = [regret_2; cumsum(max(environment)- environment(MatrixArmsPlayed_2(run,:)))];
end
if holding == 0
   figure; 
   grid on
