function plottingAdversarialRegret_Fill(environment,Matrixgain,Matrixgain_2, col, holding)
...
for run = 1:NbrRuns;
    ...
    regret_2 = [regret_2; max(cumsum(environment)')- cumsum(Matrixgain_2(run,:))];
end
if holding == 0
   figure; 
   grid on
